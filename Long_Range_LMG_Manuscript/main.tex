...
This phenomenon is \blue{fairly} general in nature, and can be readily adapted to \blue{some} non-integrable systems \blue{particularly after addition of integrability fields or in the presence of long range interactions. For instance, if we apply integrability field,} 
\begin{equation}
