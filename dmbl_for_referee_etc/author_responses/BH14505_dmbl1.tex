...
\begin{document}
	...
	\begin{align}
		...
		\label{eq:jwa}
	\end{align}
	The Eq.~\eqref{eq:jwa} is independent of the driving force and it can be observed that $\comm{\tilde{H}^{RWA}_{XXZ_k}}{\hat{c}^\dagger_k\hat{c}_k}=0.$ Consequently, the XXZ model is localized regardless of the drive parameters that are available. 
	\begin{figure}[t!]
		\includegraphics[width=7.5cm]{corrN8sz0sz3avg_xxz.jpeg}
