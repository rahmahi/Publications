...
\begin{document}
	...
	\begin{enumerate}
		...
		\item In order to enhance clarity, we have consistently expressed the Hamiltonian as Eq. 25 solely in terms of spin operators, rather than pauli spin matrices. This notation was introduced on page 6, section 2, paragraph 1, and has been maintained throughout the rest of the  manuscript. 
		\item There was an ambiguity in the summation over spins. The subscripts of the summation have been changed to $i<j$ in the revised manuscript, since we are summing over bonds.
