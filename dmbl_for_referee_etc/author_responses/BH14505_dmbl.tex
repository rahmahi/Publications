...
\begin{document}
	...
	\begin{enumerate}
		...
		\item The typographical error has been corrected and the expression of eq.(26) has been revised from $\displaystyle \mel{s_i}{\hat{H_0}}{s_j} = -\frac{4}{N-1} s^2_i \delta_{ij}$ to $\displaystyle \mel{s_i}{\hat{H_0}}{s_j} = -\frac{2}{N-1} s^2_i \delta_{ij}$. Furthermore, we have made a correction to the second part of equation (26) by including a negative sign.
