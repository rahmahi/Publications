...
\begin{textblock*}{6.5cm}(13cm,14.5cm) % Adjust the position (2cm,2cm) as needed
	\includegraphics[width=6.5cm]{hbar_avg_std_w0.7.jpg}
...
\item We have briefly discussed in conclusion sention, if our method of achieving a phase cross over is not possible like XXZ model. 
\end{enumerate}
