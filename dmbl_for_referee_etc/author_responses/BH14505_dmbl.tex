...
\begin{document}
	...
	\begin{enumerate}
		...
		\item We have corrected the typo graphical error and revised the expression of eq.(26) from $\displaystyle \mel{s_i}{\hat{H_0}}{s_j} = -\frac{4}{N-1} s^2_i \delta_{ij}$  to $\displaystyle \mel{s_i}{\hat{H_0}}{s_j} = -\frac{2}{N-1} s^2_i \delta_{ij}$.
